...
// Create message element with dynamic classes and show it
...
// Generate Bot respoonse using API
const generateBotResponse = async (incomingMessageDiv) => {
    ...
    try {
      ...
      console.log(error);
      messageElement.innerText = error.message;  //This is where to add the error message
...
if (contactForm) {
  contactForm.addEventListener('submit', function(e) {
    ...
    setTimeout(() => {
           const messageContent = `<svg class="bot-avatar" xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 16 16">
...
// Initialize emoji picker and emoji selection
